      ...
      <div class="flex items-center gap-3">
        <VMenu location="bottom end">
          ...
          <VCard class="pa-4" style="min-width: 200px">
            ...
            <VRow dense>
              <VCol v-for="(config, status) in nodeStatus" :key="status" cols="6" class="flex justify-center">
                <VChip size="small" rounded :color="config.color" :style="{ color: config.textColor }">
                  <template #prepend>
